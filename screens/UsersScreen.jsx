  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        `${serverLink}api/dashboardNumbers/${user.id}`
      );
  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: "white" }}>
      ...
      >
        ...
        >
          <ProgressBar
            data={clints ? clints.unactiveClients : 0}
            total={100}
            Date={"العملاء بدون دفع"}
            MiniLogo={NoMoneyLogo}
            hasRedBorder={true}
          />
        </View>
        <View
        ...
        >
          ...
          <View>
            ...
            >
              ...
              >
                <ProgressBar
                  data={clints ? clints.dayClients : 0}
                  total={clints ? clints.weekClients : 0}
                  IconLogo={PlusLogo}
                  MiniLogo={userLogo}
                  Date={"عملاء اليوم"}
                />
            ...
            >
              ...
              >
                <ProgressBar
                  data={clints ? clints.weekClients : 0}
                  total={clints ? clints.monthClients : 0}
                  IconLogo={PlusLogo}
                  MiniLogo={userLogo}
                  Date={"عملاء الأسبوع"}
                />
            ...
            >
              ...
              >
                <ProgressBar
                  data={clints ? clints.monthClients : 0}
                  total={clints ? clints.allClients : 0}
                  IconLogo={PlusLogo}
                  MiniLogo={userLogo}
                  Date={"عملاء الشهر"}
                />
