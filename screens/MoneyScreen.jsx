        ...
        >
          ...
          <View style={{ flexDirection: "column", justifyContent: "center" }}>
            ...
            <View style={{ flexDirection: "row", alignSelf: "center" }}>
              <Text
                style={{ color: "black", marginRight: 10, fontWeight: "bold" }}
              >
        ...
        >
          ...
          <View>
            ...
            >
              ...
              >
                <ProgressBar
                  data={Income ? Income.dayAmount : 0}
                  total={Income ? Income.weekAmount : 0}
                  IconLogo={DayLogo}
                  MiniLogo={moneyLogo}
                  Date={"هذا اليوم"}
                />
            ...
            >
              ...
              >
                <ProgressBar
                  data={Income ? Income.weekAmount : 0}
                  total={Income ? Income.monthAmount : 0}
                  IconLogo={WeekLogo}
                  MiniLogo={moneyLogo}
                  Date={"هذا الأسبوع"}
                />
            ...
            >
              ...
              >
                <ProgressBar
                  data={Income ? Income.monthAmount : 0}
                  total={Income ? Income.totalAmount : 0}
                  IconLogo={MonthLogo}
                  MiniLogo={moneyLogo}
                  Date={"هذا الشهر"}
                />
