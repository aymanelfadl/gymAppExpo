...
import { Modal, View, Text, Image, TouchableOpacity, FlatList, TextInput, StyleSheet } from 'react-native';
...
const HistPaymentModal = ({ onClose, userData, serverLink }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`${serverLink}api/client/payments/${userData.id}`);
